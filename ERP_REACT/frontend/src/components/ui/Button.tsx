...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  accent:
    'bg-seaop-accent-600 text-white hover:bg-seaop-accent-700 active:bg-seaop-accent-800 dark:bg-seaop-accent-500 dark:hover:bg-seaop-accent-600',
  ghost:
  ...
  outline:
    'bg-transparent border border-gray-300 text-gray-700 hover:bg-gray-50 active:bg-gray-100 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800',
};
