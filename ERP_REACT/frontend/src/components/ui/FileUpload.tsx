  ...
  return (
    <div className="space-y-3">
      ...
      <div
        ...
        className={clsx(
          'flex flex-col items-center justify-center rounded-lg border-2 border-dashed p-4 sm:p-6 cursor-pointer transition-colors',
          isDragging
      ...
      >
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 text-center">
          ...
          <span className="sm:hidden">Appuyez pour choisir un fichier</span>
        </p>
